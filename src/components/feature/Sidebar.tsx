...
export function Sidebar({ userRole }: SidebarProps) {
  ...
  const commercialMenuItems = [
    ...
    { icon: 'ri-user-add-line', label: 'Leads', path: '/commercial/leads' },
  ...
  const getMenuItems = () => {
    ...
    if (location.pathname.startsWith('/commercial')) {
      return [
        ...
        { path: '/commercial/leads', icon: 'ri-user-star-line', label: 'Leads' },
        { path: '/commercial/pipeline', icon: 'ri-flow-chart', label: 'Pipeline' },
        { path: '/commercial/activities', icon: 'ri-calendar-check-line', label: 'Activités' },
        { path: '/commercial/analytics', icon: 'ri-line-chart-line', label: 'Performance' },
        { path: '/commercial/produits', icon: 'ri-shopping-bag-line', label: 'Produits' },
        { path: '/commercial/commissions', icon: 'ri-money-euro-circle-line', label: 'Commissions' },
    ...
    return [
      ...
      { path: '/commercial/pipeline', icon: 'ri-flow-chart', label: 'Pipeline' },
      { path: '/commercial/activities', icon: 'ri-calendar-check-line', label: 'Activités' },
      { path: '/commercial/analytics', icon: 'ri-line-chart-line', label: 'Analytics' },
      { path: '/commercial/commissions', icon: 'ri-money-euro-circle-line', label: 'Commissions' },
      { path: '/commercial/profile', icon: 'ri-user-line', label: 'Mon Profil' },
      { path: '/commercial/call-for-tenders', icon: 'ri-file-list-3-line', label: 'Appels d\'Offres' },
      { path: '/commercial/entretiens', icon: 'ri-calendar-event-line', label: 'Entretiens' },
